		...
		vc: {
			...
			zh: {
				...
				sl: {
					h2: '什么是语音链',
					h4: '一场颠覆性的语音革命已经到来',
					p1: '我们首当其冲提出：用区块链技术构建一个语音万维网。我们创造并实现一个真正意义上的说比写快的语音区块链新生代！',
					p2: '全球化开启语音万维网新纪元，开发者一站式发布语音服务，全世界的公众可以免费享用任何语音服务，实现了真正意义上的语音服务共享。任何用户，可以在世界的任何地方，与已注册的语音服务通话。 智能设备制造商将不再需要请开发者注册他们的语音服务。该方案在节省了大量开发资源的同时，也为用户提供了更便捷的方式来浏览开放的语音万维网。随着传统的基于浏览器的网站演变成为语音对话服务，传统域名系统将会进化成去中心化的语音域名系统，加密货币将成为语音服务支付的全球标准。非同凡响，不负众望，就是我们要完成的底层技术。',
					i: [{
							h4: '智能',
							p: '智能助理，随唤随到',
						},
				...
				team: {
					...
					i: [{
							h4: '赵建文',
							h5: '创始人',
							p1: '连续创业者。移动即通基础技术发明人、“微信”技术专利发明人。曾管理过盛大通行证产品、阿里巴巴旗下优酷土豆播放业务线，运营过中国最早的知识问答社区。伊利诺伊大学MBA，曾先后在Stanford、UC Berkeley进修人工智能和区块链技术，暨创立语音人工智能平台之后，在硅谷发起了语音链项目。',
						},
						{
							h4: '邵懿',
							h5: '市场总监',
						...
						},
						{
							h4: '段勇',
							h5: '大数据和机器学习专家',
							p1: '原WiFi万能钥匙大数据专家。16年大数据从业经验，精通大数据，商业智能（BI），数据挖掘，机器学习，深度学习技术。在国内数据挖掘先驱企业华院数据任职多年后，联合创立杭州数云信息技术有限公司并担任CTO，先后获得“最佳电商CRM服务商”，“金牌淘拍档”等称号，成功获得了红杉资本A轮和阿里巴巴C轮投资。 ',
						},
						{
							h4: 'Kyle Bao 博士',
							h5: '密码学家',
							p1: 'Lehigh University电子工程和无线通讯专业博士，曾先后在华为、飞利浦、诺基亚、LG 担任Research Engineer，负责新算法和无线通讯标准的研究，目前在为美国国家标准技术研究所（NIST）设计量子安全的密码学标准。',
						},
						{
							h4: 'Joyce Zhang',
							h5: '财务总监',
							p1: '原北美中央财经大学校友会主席，美国方胜集团总裁，20年财务管理和金融投资经验，国际注册内部审计师，注册会计师， 高级经济分析师，曾在建设银行和人民保险公司工作，清华大学、伊利诺伊大学MBA。',
						},
						{
							h4: 'Craig Watts',
							h5: '首席战略官',
							p1: '联合创办移动广告公司Madhouse并成功退出，担任WPP数字媒体总经理，日本大阪大学媒体学博士，芝加哥大学英语硕士，精通汉语和日语。',
						},
						{
							h4: 'Terry Fogarty',
							h5: '语言学家',
						...
						},
						{
							h4: '顾冬晨',
							h5: '首席产品官',
							p1: "担任中国电信物联网运营总监，华东师范大学经济学硕士 。负责物联网开放实验室运营，拥有相当物联网相关产品、运营、开发经验。累计获授 权专利19项、发布ITU标准7项；对OFO、Haier等100多家大客户的合作产品提供开发 、测试、咨询、技术支持；负责天翼物联产业联盟运营，拥有大量产业资源。成员发展超300家，包括Intel、高 通、博世、IBM等；举行多次国际产业链高峰论坛、博览会；拥有1000+行业解决方案 ；专网用户突破1亿。",
						},
					]
				},
				dev: {
				...
				aa: {
					...
					i: [{
							h4: '李儒雄',
							h5: '创业导师',
							p1: "连邦软体连锁组织创始人、总裁，8848电子商务公司联合创始人，武汉光谷软体有限公司董事长兼总经理，中国软件行业协会常务理事，北京软件行业协会执委，被国家科技部高技术中心聘为科技经济专家委员会专家，参加过“863”计划软件项目可行性分析及评审工作，与小米科技董事长雷军三次联手创业。",
						},
						{
							h4: '刘兵 教授',
							h5: '人工智能顾问',
							p1: "刘兵教授是ACM Fellow以及IEEE Fellow，主要从事语义分析、观点挖掘、机器学习以及自然语言处理方面的研究。他有两篇论文在KDD会议中获得“10-year test-of-time”奖项，其工作曾被纽约时报头版报道。刘兵教授还担任ACM SIGKDD Chair, DMKD Action Editor，TWEB、KAIS等期刊的Associate Editor。",
						},
						{
							h4: '贺海武 教授',
							h5: '项目执行顾问',
							p1: "基于区块链的分布式云计算平台iExec（云算宝）联合创始人，中科院网络信息中心百人计划研究员。法国国立里尔科学技术大学(USTL)博士，法国国家认证副教授资，法国国家认证高性能专家。从2013年起，入选教育部“ 春晖计划”，成为教育部“春晖学者”。2015年8月当选成为中国计算机学会CCF协同计算专委会委员，2015年11月当选成为中国计算机学会CCF高性能计算专委会委员，服务计算专委会委员。2015年成为卡塔尔基金会项目国际评委。",
						},
						{
							h4: '黄连金',
							h5: '区块链顾问',
							p1: "黄连金先生，原华为区块链科学家，美国ACM Practitioner Board 委员、中国电子学会区块链专家委员、MBA。曾在中国最大非上市通信科技公司华为担任技术副总裁、首席区块链科学家；曾任职加拿大CGI集团公司（主营IT咨询），担任技术总监、云安全技术负责人。",
						},
						{
							h4: '凌棕 博士',
							h5: 'FinTech/Blockchain科学家',
							p1: "电子工程博士，美国IBM公司IBM Almaden 研究中心科学家，中国科技大学软件学院兼职教授、软件技术部主任。凌棕博士目前专注于FinTech /Blockchain，认知业务和AI，大数据存储和分析，云计算架构，物联网领域。作为IBM公司的杰出校园大使和多所高校的兼职教授，凌棕博士不但为美国硅谷地区的斯坦福大学和加州大学伯克利分校开设专题技术课程，并在中国顶尖大学举办了多次研讨会。为了表彰他对社区的贡献，凌博士近十年来一直是美国总统志愿者服务奖的获得者。",
						},
						{
							h4: '陈利人',
							h5: '人工智能顾问',
							p1: "人工智能和区块链公司数知科技的联合创始人和CTO。连环创业者，16年创业公司屏芯科技被美团收购，13年创业公司云云网被新浪收购，11年创业公司vivisimo一亿美金被IBM收购。在Google七年，负责从事大规模系统和搜索系统研发。之前任360移动搜索负责人，盘古搜索CTO。毕业于Carnegie Mellon University，和清华大学计算机系。",
						},
						{
							h4: '车德明',
							h5: '犇远资本 管理合伙人',
						...
						},
						{
							h4: '李明顺',
							h5: '天使投资人/董事',
							p1: "好贷网CEO。中国互联网发展的见证者、参与者、缔造者。资深互联网从业者和创业者，互联网金融千人会（IFC1000）的执委、发起人。曾担任康盛公司副总裁，中国最大的社区平台Discuz!的联合创始人，并带领公司于2010年以近5000万美元被腾讯全资收购。更早之前，曾在网易、CBSi等互联网公司担任过核心骨干和主管职务，是中国互联网协会的顾问和北大、上海交大等多所知名高校的创业导师。",
						},
					],
				},
				partners: {
